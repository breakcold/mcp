...
Use these examples to connect Breakcold MCP to common AI tools.

| Application | Description | Default bearer-token scopes |
| --- | --- | --- |
| [Claude](../examples/claude.md) | Connect Breakcold to Claude as a remote MCP server with OAuth. | `records:read` |
| [ChatGPT](../examples/chatgpt.md) | Connect Breakcold to ChatGPT apps or custom MCP apps. | `records:read` |
...
OAuth is recommended when the application supports sign-in. Bearer-token scopes are shown for clients that need service-style access.
